...
import nehalSirImg from "../src/PageGroup/People/assets/nehalSirImg.jpeg";
import bashirSirImg from "../src/PageGroup/About/assets/bashialam.jpg";
...
export const faculty_data = [
  {
    ...
    portfolio: "Professional Portfolio",
    pdf: "https://www.jmi.ac.in/upload/employeeresume/balam2.pdf",
    areaOfIntrest:
  ...
  },
  {
    ...
    portfolio: "Professional Portfolio",
    pdf: "https://www.jmi.ac.in/upload/employeeresume/tahmad2.pdf",
    areaOfIntrest:
      "Text Mining, Graph Mining, Bigdata Analytics, Natural Language Processing.",
    details:
      "Dr. Tanvir Ahmad is currently in the Department of Computer Engineering, Faculty of Engineering and Technology, Jamia Millia Islamia, New Delhi-110025. He has been involved with Department of Computer Engineering, Jamia Millia Islamia for over 13 years. He received his B.Sc. (Computer Sc.) from Bangalore University with First Class, M.Tech (I.T). from I.P. University, New Delhi in 2006 and Ph.D. on “Frequent and Sequential Pattern Mining and their Applications”, from Jamia Millia Islamia ,New Delhi in 2013.He has more than twenty years of academic, research, training and administrative experiences in the field of Computer Engineering. His areas of research are Text Mining, Graph Mining, Big Data Analytics, Natural Language Processing, Information Security. Prof. Tanvir Ahmad is an active researcher. He has more than 100 citations in referred journals, more that 20 papers indexed in SCOPUS and more that 26 papers indexed in Google scholar. Several students have been awarded PhD under his able guidance and several students are working under his supervision. He is Reviewer for Springer Journal for Neural Computing and Application. He member of Advisory Group for Digital Locker system, National e-Governance Division, Ministry of I.T. and Communication, Govt. of India. He is also member of Expert Committee of National Board of Accreditation (NBA) and of Expert Committee for affiliation to colleges for M.Tech, B.Tech and MCA under G.G.S.I.P. University since 2010. Prof Tanvir Ahmad is Hony. Additional Director of, FTK-Centre for Information Technology, for Website and MIS , Jamia Millia Islamia, New Delhi. He has worked as Head of Department of Computer Engineering from February, 2014 to February 2017. He is also a Member of Faculty Committee and Member of Board of Studies of Department of Computer Engineering, Jamia Millia Islamia. He was also the Chairman of Departmental Research Committee from Feb, 2014 to Feb, 2017 and President of Subject Association from Feb, 2014 to Feb, 2017. He is Chairman, of Syllabus Committee for drafting the course structure of M.Tech. in Computer Engineering. He is Teacher placement co-ordinator for Department of Computer Engineering from last 8 years. He is a Member of Jamia Teachers Association and Member of Sub-purchase committee of Department of Computer Engineering M.Tech (Computer Engineering), B.Tech (Computer Engineering), B.E. (Computer Engineering), M.C.A., M.Sc (Computer Science), M.Sc (Industrial Maths with Computer Application), B.C.A., Diploma Engineering.",
  },
  {
  ...
  },
  {
    ...
    details:
      "Dr. Mumtaz Ahmed is currently Assistant Professor in the Department of Computer Engineering, Faculty of Engineering and Technology, Jamia Millia Islamia, New Delhi-110025. He has more than 9 years of teaching experiences in the field of Computer Engineering. He is pursuing his Ph.D from Jamia Millia Islamia, New Delhi, had received his M.TECH from Delhi College Of Engineering, New Delhi in 2013 and B.TECH from Jamia Millia Islamia in 2004. Dr. Mumtaz Ahmed has published a total of 7 papers , 2 of which are in National/International Conferences and rest are in National/International Journals. He has also taken part in various Workshop/Conferences including ISTE workshop on Database Management System conducted by IIT-Bombay fomr 13th to 23rd Dec 2010. His research interest includes Computer Networks, Artificial Intelligence and Operating Systems",
  },
  {
    ...
    portfolio: "Professional Portfolio",
    areaOfIntrest:
      "Multimedia security, Chaos-based cryptography, Cyber security, Machine learning & Deep learning, and Optimization techniques.",
  ...
  },
  {
    ...
    portfolio: "Professional Portfolio",
    areaOfIntrest:
      "Information Extraction, Text Mining, Machine Learning, Soft Computing",
    pdf: "https://www.jmi.ac.in/upload/employeeresume/mzansari.pdf",
    details:
  ...
  },
  {
    ...
    pdf: "https://www.jmi.ac.in/upload/employeeresume/fahmad1.pdf",
    details:
  ...
  },
  {
    ...
    areaOfIntrest:
      "Software Engineering and Testing, Artificial Intelligence, Operating System, Computer Networks",
    pdf: pdf,
    details:
